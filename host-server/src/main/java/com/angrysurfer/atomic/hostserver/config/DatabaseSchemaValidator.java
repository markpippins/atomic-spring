...
public class DatabaseSchemaValidator {
    ...
    private void validateAndFixForeignKeyColumns(Connection conn) throws SQLException {
        // Define the mappings of tables and their foreign key columns that should be BIGINT
        String[][] fkMappings = {
    ...
    private void validateAndFixForeignKeyColumn(Connection conn, String tableName, String columnName) throws SQLException {
        String sql = "SELECT DATA_TYPE FROM INFORMATION_SCHEMA.COLUMNS " +
