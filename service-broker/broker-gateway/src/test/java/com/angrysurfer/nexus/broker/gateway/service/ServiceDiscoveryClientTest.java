...
class ServiceDiscoveryClientTest {
        ...
        void findServiceByOperation_WithExistingService_ShouldReturnServiceInfo() {
                ...
                // When
                Optional<com.angrysurfer.spring.nexus.broker.spi.ServiceDiscoveryClient.ServiceInfo> result = discoveryClient
        ...
        void getServiceDetails_WithExistingService_ShouldReturnServiceDetails() {
                ...
                // When
                Optional<com.angrysurfer.spring.nexus.broker.spi.ServiceDiscoveryClient.ServiceDetails> result = discoveryClient
