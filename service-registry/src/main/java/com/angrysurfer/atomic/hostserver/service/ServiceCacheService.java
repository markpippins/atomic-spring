...
public class ServiceCacheService {
     ...
     */
    public Optional<com.angrysurfer.atomic.hostserver.entity.Service> getService(Long id) {
        ...
        if (isCacheAvailable()) {
            try {
                ...
                if (cached != null) {
                    ...
                    return Optional.of((com.angrysurfer.atomic.hostserver.entity.Service) cached);
                }
            } catch (Exception e) {
        ...
        Optional<com.angrysurfer.atomic.hostserver.entity.Service> service = serviceRepository.findById(id);
     ...
     */
    public Optional<com.angrysurfer.atomic.hostserver.entity.Service> getServiceByName(String name) {
        ...
        Optional<com.angrysurfer.atomic.hostserver.entity.Service> service = serviceRepository.findByName(name);
     ...
     */
    public List<com.angrysurfer.atomic.hostserver.entity.Service> getAllServices() {
        if (isCacheAvailable()) {
            try {
                @SuppressWarnings("unchecked")
                List<com.angrysurfer.atomic.hostserver.entity.Service> cached = (List<com.angrysurfer.atomic.hostserver.entity.Service>) redisTemplate
        ...
        List<com.angrysurfer.atomic.hostserver.entity.Service> services = serviceRepository.findAll();
     ...
     */
    @Transactional
    public com.angrysurfer.atomic.hostserver.entity.Service createService(
            com.angrysurfer.atomic.hostserver.entity.Service service) {
        com.angrysurfer.atomic.hostserver.entity.Service saved = serviceRepository.save(service);
        cacheService(saved);
     ...
     */
    @Transactional
    public com.angrysurfer.atomic.hostserver.entity.Service updateService(
            com.angrysurfer.atomic.hostserver.entity.Service service) {
        com.angrysurfer.atomic.hostserver.entity.Service updated = serviceRepository.save(service);
     ...
     */
    private void cacheService(com.angrysurfer.atomic.hostserver.entity.Service service) {
        if (!isCacheAvailable())
            return;
        try {
     ...
     */
    private void evictService(com.angrysurfer.atomic.hostserver.entity.Service service) {
        if (!isCacheAvailable())
            return;
        try {
