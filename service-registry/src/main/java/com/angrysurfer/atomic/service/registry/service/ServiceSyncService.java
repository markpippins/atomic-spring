...
public class ServiceSyncService {
    ...
    private final com.angrysurfer.atomic.service.registry.repository.ServiceTypeRepository serviceTypeRepository;
    ...
    public ServiceSyncService(ServiceRepository serviceRepository,
                              com.angrysurfer.atomic.service.registry.repository.ServiceTypeRepository serviceTypeRepository,
    ...
    private void processRegistrations(List<ServiceRegistration> registrations) {
        ...
        com.angrysurfer.atomic.service.registry.entity.ServiceType restApiType =
        ...
        for (ServiceRegistration reg : registrations) {
            try {
                ...
                Optional<com.angrysurfer.atomic.service.registry.entity.Service> existingOpt =
                ...
                if (existingOpt.isPresent()) {
                    ...
                    service = new com.angrysurfer.atomic.service.registry.entity.Service();
