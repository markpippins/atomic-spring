...
import com.angrysurfer.spring.atomic.broker.api.ServiceRegistration;
...
public class ServiceSyncService {
    ...
    private final com.angrysurfer.spring.atomic.repository.ServiceTypeRepository serviceTypeRepository;
    ...
    public ServiceSyncService(ServiceRepository serviceRepository,
                              com.angrysurfer.spring.atomic.repository.ServiceTypeRepository serviceTypeRepository,
    ...
    private void processRegistrations(List<ServiceRegistration> registrations) {
        ...
        com.angrysurfer.spring.atomic.entity.ServiceType restApiType =
        ...
        for (ServiceRegistration reg : registrations) {
            try {
                ...
                Optional<com.angrysurfer.spring.atomic.entity.Service> existingOpt =
                ...
                if (existingOpt.isPresent()) {
                    ...
                    service = new com.angrysurfer.spring.atomic.entity.Service();
