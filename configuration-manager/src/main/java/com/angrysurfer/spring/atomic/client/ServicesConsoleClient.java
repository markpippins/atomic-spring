package com.angrysurfer.spring.atomic.client;

import com.angrysurfer.spring.atomic.entity.*;
import com.angrysurfer.spring.atomic.repository.*;
...
public class ServicesConsoleClient {
    ...
    // --- Services ---
    public List<com.angrysurfer.spring.atomic.entity.Service> getServices() {
        log.info("Fetching all services from database");
        return serviceRepository.findAll();
    }

    public Optional<com.angrysurfer.spring.atomic.entity.Service> findServiceByName(String name) {
