package com.angrysurfer.spring.nexus.service;
...
public class ServiceCacheService {
     ...
     */
    public Optional<com.angrysurfer.spring.nexus.entity.Service> getService(Long id) {
        ...
        if (isCacheAvailable()) {
            try {
                ...
                if (cached != null) {
                    ...
                    return Optional.of((com.angrysurfer.spring.nexus.entity.Service) cached);
                }
            } catch (Exception e) {
        ...
        Optional<com.angrysurfer.spring.nexus.entity.Service> service = serviceRepository.findById(id);
     ...
     */
    public Optional<com.angrysurfer.spring.nexus.entity.Service> getServiceByName(String name) {
        ...
        Optional<com.angrysurfer.spring.nexus.entity.Service> service = serviceRepository.findByName(name);
     ...
     */
    public List<com.angrysurfer.spring.nexus.entity.Service> getAllServices() {
        if (isCacheAvailable()) {
            try {
                @SuppressWarnings("unchecked")
                List<com.angrysurfer.spring.nexus.entity.Service> cached = (List<com.angrysurfer.spring.nexus.entity.Service>) redisTemplate
        ...
        List<com.angrysurfer.spring.nexus.entity.Service> services = serviceRepository.findAll();
     ...
     */
    @Transactional
    public com.angrysurfer.spring.nexus.entity.Service createService(
            com.angrysurfer.spring.nexus.entity.Service service) {
        com.angrysurfer.spring.nexus.entity.Service saved = serviceRepository.save(service);
        cacheService(saved);
     ...
     */
    @Transactional
    public com.angrysurfer.spring.nexus.entity.Service updateService(
            com.angrysurfer.spring.nexus.entity.Service service) {
        com.angrysurfer.spring.nexus.entity.Service updated = serviceRepository.save(service);
     ...
     */
    private void cacheService(com.angrysurfer.spring.nexus.entity.Service service) {
        if (!isCacheAvailable())
            return;
        try {
     ...
     */
    private void evictService(com.angrysurfer.spring.nexus.entity.Service service) {
        if (!isCacheAvailable())
            return;
        try {
